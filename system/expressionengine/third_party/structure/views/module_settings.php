<?php if ( ! $permissions['admin']) $this->functions->redirect($foundation->moduleURL());?>
...
<table class="structure-table" border="0" cellspacing="0" cellpadding="0">
	...
	<tbody>
		<tr>
			<td><?= lang('ee_27_info')?> <strong><a href="<?=$foundation->moduleURL('hook_change_27');?>"><?= lang('ee_27_link') ?></a></strong></td>
		</tr>
	</tbody>
</table>
<?php } ?>
