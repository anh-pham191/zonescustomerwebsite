...
require_once PATH_THIRD.'structure/helpers/eeharbor_abstracted.php';
...
class EEHelper extends \structure\EEHarbor_abstracted {
	...
	private function initiateSettings()
	{
		...
		$addonSettings = require PATH_THIRD.'structure/addon.setup.php';
