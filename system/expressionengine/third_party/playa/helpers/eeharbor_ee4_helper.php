...
require_once PATH_THIRD.'playa/helpers/eeharbor_abstracted.php';
...
class EEHelper extends \playa\EEHarbor_abstracted {
	...
	private function initiateSettings()
	{
		...
		$addonSettings = require PATH_THIRD.'playa/addon.setup.php';
