 ...
 */
(function(e,f,b){var d=/\+/g;function g(j){return j}function h(j){return c(decodeURIComponent(j.replace(d," ")))}function c(j){if(j.indexOf('"')===0){j=j.slice(1,-1).replace(/\\"/g,'"').replace(/\\\\/g,"\\")}return j}function i(j){return a.json?JSON.parse(j):j}var a=e.cookie=function(r,q,w){if(q!==b){w=e.extend({},a.defaults,w);if(q===null){w.expires=-1}if(typeof w.expires==="number"){var s=w.expires,v=w.expires=new Date();v.setDate(v.getDate()+s)}q=a.json?JSON.stringify(q):String(q);return(f.cookie=[encodeURIComponent(r),"=",a.raw?q:encodeURIComponent(q),w.expires?"; expires="+w.expires.toUTCString():"",w.path?"; path="+w.path:"",w.domain?"; domain="+w.domain:"",w.secure?"; secure":""].join(""))}var j=a.raw?g:h;var u=f.cookie.split("; ");var x=r?null:{};for(var p=0,n=u.length;p<n;p++){var o=u[p].split("=");var k=j(o.shift());var m=j(o.join("="));if(r&&r===k){x=i(m);break}if(!r){x[k]=i(m)}}return x};a.defaults={};e.removeCookie=function(k,j){if(e.cookie(k)!==null){e.cookie(k,null,j);return true}return false}})(jQuery,document);$(function(){$("#right-getintouch").validate({submitHandler:function(a){$("#prog1").fadeIn(100);$.ajax({url:$(a).attr("action"),type:"POST",data:$(a).serialize(),success:function(b){if(b.match(/NoPrefTime/i)){$("#prog1").fadeOut(200);$(".instructions-rh").html("Please let us know when you would prefer to be contacted").css({color:"red"})}else{if(b.match(/NoPrivacy/i)){$("#prog1").fadeOut(200);$(".instructions-rh").html("You must read and accept the Privacy Policy in order to continue").css({color:"red"})}else{if(b.match(/Invalid/i)){$("#prog1").fadeOut(200);$(".instructions-rh").html("There was an error, please try again.").css({color:"red"})}else{if(b.match(/Unsuccessful/i)){$("#prog1").fadeOut(200);$("#form1").html("<h2>Your form could not be submitted. Please try again later or call us on (09) 303 0670.</h2>")}else{$("#prog1").fadeOut(200);$("#form1").html('<h2>Thank you for your enquiry</h2> <p>We will be in touch soon to discuss your landscaping enquiry.</p><p><a href="/">Back to home page</a></p>').css("display","none");$(".theformarea-rh").css("border","none");$("#form2").load("/forms/getintouch-extra/").fadeIn(1200);$(".adwordstracking").html('<iframe src="/adwords/right-getintouch.html" style="width: 0px; height: 0px;">');_gaq.push(["_trackEvent","Enquiry submitted","Submit enquiry","0002 Zones - Right hand side get in touch stage 1"]);ga("send","event","Enquiry submitted","Submit enquiry","0002 Zones - Right hand side get in touch stage 1")}}}}},error:function(){$("#prog1").fadeOut(1000);$("#form1").html("<h2>Your form could not be submitted. Please try again later or call us on (09) 303 0670.</h2>")}})}});$("#myform-contact-enquiry").validate({submitHandler:function(a){$("#prog1").fadeIn(100);$.ajax({url:$(a).attr("action"),type:"POST",data:$(a).serialize(),success:function(b){if(b.match(/NoPrefTime/i)){$("#prog1").fadeOut(200);$(".instructions-c").html("Please let us know when you would prefer to be contacted").css({color:"red",display:"block"})}else{if(b.match(/NoPrivacy/i)){$("#prog1").fadeOut(200);$(".instructions-c").html("You must read and accept the Privacy Policy in order to continue").css({color:"red",display:"block"})}else{if(b.match(/Invalid/i)){$("#prog1").fadeOut(200);$(".instructions-c").html("There was an error, please try again.").css({color:"red",display:"block"})}else{if(b.match(/Unsuccessful/i)){$("#prog1").fadeOut(200);$(".theformarea-c").html("<h3>Your form could not be submitted. Please try again later or call us on (09) 303 0670</h3>")}else{$("#prog1").fadeOut(200);$(".theformarea-c").html("<h3>Thank you for your enquiry, we will be in touch soon.</h3>");$(".adwordstracking").html('<iframe src="/adwords/contact-enquiry.html" style="width: 0px; height: 0px;">');_gaq.push(["_trackEvent","Enquiry submitted","Submit enquiry","0002 - Zones - Landscape Design Enquiry"]);ga("send","event","Enquiry submitted","Submit enquiry","0002 - Zones - Landscape Design Enquiry")}}}}},error:function(){$("#prog1").fadeOut(200);$(".theformarea-c").html("<h3>Your form could not be submitted. Please try again later or call us on (09) 303 0670</h3>")}})}});$("#myform-contact-business").validate({submitHandler:function(a){$("#prog1").fadeIn(100);$.ajax({url:$(a).attr("action"),type:"POST",data:$(a).serialize(),success:function(b){if(b.match(/NoPrivacy/i)){$("#prog1").fadeOut(200);$(".instructions-c").html("You must read and accept the Privacy Policy in order to continue").css({color:"red",display:"block"})}else{if(b.match(/Invalid/i)){$("#prog1").fadeOut(200);$(".instructions-c").html("There was an error, please try again.").css({color:"red",display:"block"})}else{if(b.match(/Unsuccessful/i)){$("#prog1").fadeOut(200);$(".theformarea-c").html("<h3>Your form could not be submitted. Please try again later or call us on (09) 303 0670</h3>")}else{$("#prog1").fadeOut(200);$(".theformarea-c").html("<h3>Thank you for your enquiry, we will be in touch soon.</h3>");$(".adwordstracking").html('<iframe src="/adwords/contact-bus.html" style="width: 0px; height: 0px;">');_gaq.push(["_trackEvent","Enquiry submitted","Submit enquiry","0002 Zones - Business Opportunity"]);ga("send","event","Enquiry submitted","Submit enquiry","0002 Zones - Business Opportunity")}}}},error:function(){$("#prog1").fadeOut(200);$(".theformarea-c").html("<h3>Your form could not be submitted. Please try again later or call us on (09) 303 0670</h3>")}})}});$("#myform-contact-career").validate({submitHandler:function(a){$("#prog1").fadeIn(100);$.ajax({url:$(a).attr("action"),type:"POST",data:$(a).serialize(),success:function(b){if(b.match(/NoPrivacy/i)){$("#prog1").fadeOut(200);$(".instructions-c").html("You must read and accept the Privacy Policy in order to continue").css({color:"red",display:"block"})}else{if(b.match(/Invalid/i)){$("#prog1").fadeOut(200);$(".instructions-c").html("There was an error, please try again.").css({color:"red",display:"block"})}else{if(b.match(/Unsuccessful/i)){$("#prog1").fadeOut(200);$(".theformarea-c").html("<h3>Your form could not be submitted. Please try again later or call us on (09) 303 0670</h3>")}else{$("#prog1").fadeOut(200);$(".theformarea-c").html("<h3>Thank you for your enquiry, we will be in touch soon.</h3>");$(".adwordstracking").html('<iframe src="/adwords/contact-career.html" style="width: 0px; height: 0px;">');_gaq.push(["_trackEvent","Enquiry submitted","Submit enquiry","0002 Zones - Career Opportunity"]);ga("send","event","Enquiry submitted","Submit enquiry","0002 Zones - Career Opportunity")}}}},error:function(){$("#prog1").fadeOut(200);$(".theformarea-c").html("<h3>Your form could not be submitted. Please try again later or call us on (09) 303 0670</h3>")}})}});$("#myform-sub").validate({submitHandler:function(a){$.ajax({url:$(a).attr("action"),type:"POST",data:$(a).serialize(),success:function(b){if(b.match(/Invalid/i)){$(".instructions-sub").html("There was an error, please try again.")}else{if(b.match(/Unsuccessful/i)){$(".theformarea-sub").html('<p class="submessage">Your form could not be submitted. Please try again later.</p>')}else{$(".theformarea-sub").html('<p class="submessage"><strong>Thank you for subscribing to our newsletter. You will receive a confirmation email shortly.</strong></p>');$(".adwordstracking-footer").html('<iframe src="/adwords/news-subscribe.html" style="width: 0px; height: 0px;">');_gaq.push(["_trackEvent","Subscribed to newsletter","Subscribe","0002 Zones Newsletter - Footer - Subscribe to newsletter"]);ga("send","event","Subscribed to newsletter","Subscribe","0002 Zones Newsletter - Footer - Subscribe to newsletter")}}},error:function(){$(".theformarea-sub").html('<p class="submessage">Your form could not be submitted. Please try again later.</p>')}})}})});function createCookie(c,d,e){if(e){var b=new Date();b.setTime(b.getTime()+(e*24*60*60*1000));var a="; expires="+b.toGMTString()}else{var a=""}document.cookie=c+"="+d+a+"; path=/"}function readCookie(b){var e=b+"=";var a=document.cookie.split(";");for(var d=0;d<a.length;d++){var f=a[d];while(f.charAt(0)==" "){f=f.substring(1,f.length)}if(f.indexOf(e)==0){return f.substring(e.length,f.length)}}return null}function eraseCookie(a){createCookie(a,"",-1)}function areCookiesEnabled(){var a=false;createCookie("testing","Hello",1);if(readCookie("testing")!=null){a=true;eraseCookie("testing")}return a}(function(a){a.reject=function(b){var d=a.extend(true,{reject:{all:false},display:[],browserShow:false,browserInfo:{},closeCookie:false,analytics:false},b);var c=function(e){return(e.all?true:false)||(e[a.os.name]?true:false)||(e[a.layout.name]?true:false)||(e[a.browser.name]?true:false)||(e[a.browser.className]?true:false)};if(!c(d.reject)){if(a.isFunction(d.onFail)){d.onFail()}return false}if(a.isFunction(d.afterReject)){d.afterReject()}return true}})(jQuery);(function(a){a.browserTest=function(e,g){var f="unknown",d="X",b=function(k,j){for(var c=0;c<j.length;c=c+1){k=k.replace(j[c][0],j[c][1])}return k},h=function(n,l,j,q){var o={name:b((l.exec(n)||[f,f])[1],j)};o[o.name]=true;if(!o.opera){o.version=(q.exec(n)||[d,d,d,d])[3]}else{o.version=window.opera.version()}if(/safari/.test(o.name)){var k=/(safari)(\/|\s)([a-z0-9\.\+]*?)(\;|dev|rel|\s|$)/;var m=k.exec(n);if(m&&m[3]&&m[3]<400){o.version="2.0"}}else{if(o.name==="presto"){o.version=(a.browser.version>9.27)?"futhark":"linear_b"}}o.versionNumber=parseFloat(o.version,10)||0;var p=1;if(o.versionNumber<100&&o.versionNumber>9){p=2}o.versionX=(o.version!==d)?o.version.substr(0,p):d;o.className=o.name+o.versionX;return o};e=(/Opera|Navigator|Minefield|KHTML|Chrome|CriOS/.test(e)?b(e,[[/(Firefox|MSIE|KHTML,\slike\sGecko|Konqueror)/,""],["Chrome Safari","Chrome"],["CriOS","Chrome"],["KHTML","Konqueror"],["Minefield","Firefox"],["Navigator","Netscape"]]):e).toLowerCase();a.browser=a.extend((!g)?a.browser:{},h(e,/(camino|chrome|crios|firefox|netscape|konqueror|lynx|msie|opera|safari)/,[],/(camino|chrome|crios|firefox|netscape|netscape6|opera|version|konqueror|lynx|msie|safari)(\/|\s)([a-z0-9\.\+]*?)(\;|dev|rel|\s|$)/));a.layout=h(e,/(gecko|konqueror|msie|opera|webkit)/,[["konqueror","khtml"],["msie","trident"],["opera","presto"]],/(applewebkit|rv|konqueror|msie)(\:|\/|\s)([a-z0-9\.]*?)(\;|\)|\s)/);a.os={name:(/(win|mac|linux|sunos|solaris|iphone|ipad)/.exec(navigator.platform.toLowerCase())||[f])[0].replace("sunos","solaris")};if(!g){a("html").addClass([a.os.name,a.browser.name,a.browser.className,a.layout.name,a.layout.className].join(" "))}};a.browserTest(navigator.userAgent)}(jQuery));var REDIRECT_URL="/site/browser";var ALT_URL="/";function returnToPrevious(){if(readCookie("browserPrevious")){var a=readCookie("browserPrevious");eraseCookie("browserPrevious");window.location.href=a}else{window.location.href=ALT_URL}}(function(b){function c(){var d=b(this);setTimeout(function(){var e=d.attr("title");if(!d.val()||(d.val()==e)){d.prev("span").css("visibility","");if(e){var f=b("<label></label>").text(e).css("visibility","hidden").appendTo("body");d.prev("span").css("margin-left",f.width()+3+"px");f.remove()}}else{d.prev("span").css("visibility","hidden")}},0)}function a(){var d=b(this).attr("title");if(!b(this).val()||(b(this).val()==d)){b(this).val(d);b(this).prev("span").css("visibility","")}}b(".form input").live("cut",c);b(".form textarea").live("cut",c);b("#topnav input").live("cut",c);b(".form input").live("keydown",c);b(".form input").live("paste",c);b(".form textarea").live("keydown",c);b(".form textarea").live("paste",c);b("#topnav input").live("keydown",c);b("#topnav input").live("paste",c);b(".form input").live("focusin",function(){b(this).prev("span").css("color","#f0f0f0")});b(".form textarea").live("focusin",function(){b(this).prev("span").css("color","#f0f0f0")});b("#topnav input").live("focusin",function(){b(this).prev("span").css("color","transparent")});b(".form input").live("focusout",function(){b(this).prev("span").css("color","#191919")});b(".form textarea").live("focusout",function(){b(this).prev("span").css("color","#191919")});b("#topnav input").live("focusout",function(){b(this).prev("span").css("color","#ffffff")});b(function(){b(".form input").each(function(){c.call(this)});b(".form textarea").each(function(){c.call(this)});b("#topnav input").each(function(){c.call(this)})});b(window).load(function(){setTimeout(function(){b(".form input").each(function(){c.call(this)});b(".form textarea").each(function(){c.call(this)});b("#topnav input").each(function(){c.call(this)})},0)})})(jQuery);(function(){var a;a=window.jQuery||window.Zepto||window.$;a.fn.fancySelect=function(d){var c,b;if(d==null){d={}}b=a.extend({forceiOS:false,includeBlank:false,optionTemplate:function(e){return e.text()},triggerTemplate:function(e){return e.text()}},d);c=!!navigator.userAgent.match(/iP(hone|od|ad)/i);return this.each(function(){var e,i,g,j,f,h,k;j=a(this);if(j.hasClass("fancified")||j[0].tagName!=="SELECT"){return}j.addClass("fancified");j.css({width:1,height:1,display:"block",position:"absolute",top:0,left:0,opacity:0});j.wrap('<div class="fancy-select">');k=j.parent();if(j.data("class")){k.addClass(j.data("class"))}k.append('<div class="trigger">');if(!(c&&!b.forceiOS)){k.append('<ul class="options">')}f=k.find(".trigger");g=k.find(".options");i=j.prop("disabled");if(i){k.addClass("disabled")}h=function(){var l;l=b.triggerTemplate(j.find(":selected"));return f.html(l)};j.on("blur.fs",function(){if(f.hasClass("open")){return setTimeout(function(){return f.trigger("close.fs")},120)}});f.on("close.fs",function(){f.removeClass("open");return g.removeClass("open")});f.on("click.fs",function(){var l,m;if(!i){f.toggleClass("open");if(c&&!b.forceiOS){if(f.hasClass("open")){return j.focus()}}else{if(f.hasClass("open")){m=f.parent();l=m.offsetParent();if((m.offset().top+m.outerHeight()+g.outerHeight()+20)>a(window).height()+a(window).scrollTop()){g.addClass("overflowing")}else{g.removeClass("overflowing")}}g.toggleClass("open");if(!c){return j.focus()}}}});j.on("enable",function(){j.prop("disabled",false);k.removeClass("disabled");i=false;return e()});j.on("disable",function(){j.prop("disabled",true);k.addClass("disabled");return i=true});j.on("change.fs",function(l){if(l.originalEvent&&l.originalEvent.isTrusted){return l.stopPropagation()}else{return h()}});j.on("keydown",function(n){var m,o,l;l=n.which;m=g.find(".hover");m.removeClass("hover");if(!g.hasClass("open")){if(l===13||l===32||l===38||l===40){n.preventDefault();return f.trigger("click.fs")}}else{if(l===38){n.preventDefault();if(m.length&&m.index()>0){m.prev().addClass("hover")}else{g.find("li:last-child").addClass("hover")}}else{if(l===40){n.preventDefault();if(m.length&&m.index()<g.find("li").length-1){m.next().addClass("hover")}else{g.find("li:first-child").addClass("hover")}}else{if(l===27){n.preventDefault();f.trigger("click.fs")}else{if(l===13||l===32){n.preventDefault();m.trigger("click.fs")}else{if(l===9){if(f.hasClass("open")){f.trigger("close.fs")}}}}}}o=g.find(".hover");if(o.length){g.scrollTop(0);return g.scrollTop(o.position().top-12)}}});g.on("click.fs","li",function(m){var l;l=a(this);j.val(l.data("raw-value"));if(!c){j.trigger("blur.fs").trigger("focus.fs")}g.find(".selected").removeClass("selected");l.addClass("selected");return j.val(l.data("raw-value")).trigger("change.fs").trigger("blur.fs").trigger("focus.fs")});g.on("mouseenter.fs","li",function(){var m,l;l=a(this);m=g.find(".hover");m.removeClass("hover");return l.addClass("hover")});g.on("mouseleave.fs","li",function(){return g.find(".hover").removeClass("hover")});e=function(){var l;h();if(c&&!b.forceiOS){return}l=j.find("option");return j.find("option").each(function(n,m){var o;m=a(m);if(!m.prop("disabled")&&(m.val()||b.includeBlank)){o=b.optionTemplate(m);if(m.prop("selected")){return g.append('<li data-raw-value="'+(m.val())+'" class="selected">'+o+"</li>")}else{return g.append('<li data-raw-value="'+(m.val())+'">'+o+"</li>")}}})};j.on("update.fs",function(){k.find(".options").empty();return e()});return e()})}}).call(this);$(function(){$(".app-folders-container").appFolders();var a=10;$("#section-sub > li").each(function(){a+=$(this).outerWidth(true)});$("#section-sub").css("width",a);var f=10;$("#section-detail > li").each(function(){f+=$(this).outerWidth(true)});$("#section-detail").css("width",f);$(".openclose").click(function(){$(this).parent().toggleClass("open")});var g=$("#section-sub").outerHeight();var h=$("#area-icons").outerHeight();var c=$("#section-detail").outerHeight();var j=g+1;var b=g+1+h+1;var i=g+1+h+1+c+1;var e=g+1+c+1;if(navlevels=="single"){var d=j}else{if(navlevels=="singleicons"){var d=b}else{if(navlevels=="double"){var d=i}else{if(navlevels=="doubletextonly"){var d=e}else{var d=0}}}}$(window).scroll(function(){if(d!=0){var k=$(window).scrollTop();if(k>d){$("#breadcrumb-wrapper").fadeIn("slow")}else{$("#breadcrumb-wrapper").fadeOut("slow")}}});$("input.uniform-styles").uniform();$("select.uniform-styles").uniform();$(".apply-fancy").fancySelect();$("a[rel^='prettyPhoto[ajax]']").prettyPhoto();$("#partner-logos").carouFredSel({width:984,align:"left",height:56,items:{visible:6,minimum:6,start:"random",width:164,height:56},scroll:{items:1,fx:"scroll",easing:"linear",duration:1200,pauseOnHover:true}});$("span.call-icon").click(function(k){$(this).css("display","none");$(".click-to-show > a").css("display","inline-block");_gaq.push(["_trackEvent","Click to call","Show phone number"]);ga("send","event","Click to call","Show phone number");k.preventDefault()})});function newPopup(a){popupWindow=window.open(a,"popUpWindow","height=700,width=800,left=10,top=10,resizable=yes,scrollbars=yes,toolbar=yes,menubar=no,location=no,directories=no,status=yes")};